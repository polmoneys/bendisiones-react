import{N as e,m as t}from"./iframe-Mz_QU2m_.js";var n=e();function r(e){return typeof e==`number`?e:e.value}function i(e,t){let n=r(e[t]),i=t;for(;i>0&&r(e[i-1])===n;)i--;let a=t;for(;a<e.length-1&&r(e[a+1])===n;)a++;if(i===0||a===e.length-1||t!==Math.floor((i+a)/2))return`none`;let o=r(e[i-1]),s=r(e[a+1]);return n>o&&n>s?`peak`:n<o&&n<s?`valley`:`none`}function a(e,t,n,a,o,s){let c={min:o??1/0,max:s??-1/0,sum:0,count:0},l=e.map(e=>r(e));(o===void 0||s===void 0)&&(c.min=Math.min(...l),c.max=Math.max(...l)),c.sum=l.reduce((e,t)=>e+t,0),c.count=l.length;let u=c.max-c.min||1,d=t/Math.max(l.length-1,1),f=n*.1;return e.map((e,t,o)=>{let s=r(e),l=typeof e==`object`?e.label:void 0,p=typeof e==`object`?e.timestamp:void 0,m=t*d,h=n-((s-c.min)/u*(n-2*f)+f),g=t/Math.max(o.length-1,1)*100,_=`flat`;if(t>0){let e=r(o[t-1]);s>e?_=`up`:s<e&&(_=`down`)}let v=i(o,t);return{x:m,y:h,value:s,index:t,percentile:g,trend:_,isExtremum:v,label:l,timestamp:p,seriesId:a}})}function o(e,t,n){if(e.length===0)return``;let r=e.map((e,t)=>`${t===0?`M`:`L`} ${e.x},${e.y}`).join(` `);if(!t)return r;let i=e[e.length-1],a=e[0];return`${r} L ${i.x},${n} L ${a.x},${n} Z`}var s=t();function c({data:e,series:t,width:i=200,height:c=50,color:l=`#3b82f6`,fillColor:u=`rgba(59, 130, 246, 0.1)`,pointMode:d=`all`,trendMode:f=`none`,showArea:p=!0,strokeWidth:m=2,dotRadius:h=3,showLegend:g=!1,stackedArea:_=!1,visibleStartPercent:v,visibleEndPercent:y,visibleStartTs:b,visibleEndTs:x,upColor:S=`#10b981`,downColor:C=`#ef4444`,flatColor:w=`#94a3b8`,peakColor:T,valleyColor:E,showPointLabels:D=`extrema`}){let O=g?30:0,k=Math.max(20,c-O),A=(0,n.useMemo)(()=>{if(e&&!t)return[{id:`default`,label:void 0,points:a(e,i,k),color:l,fillColor:u,showArea:p,strokeWidth:m}];if(t){let e=t.flatMap(e=>e.data.map(e=>r(e))),n=Math.min(...e),o=Math.max(...e);return t.map(e=>{let t=a(e.data,i,k,e.id,n,o);return{id:e.id,label:e.label,points:t,color:e.color??l,fillColor:e.fillColor??u,showArea:e.showArea??p,strokeWidth:e.strokeWidth??m}})}return[]},[e,t,i,k,l,u,p,m]),j=v===void 0?0:Math.max(0,Math.min(100,v)),M=y===void 0?100:Math.max(0,Math.min(100,y)),N=Math.min(j,M),P=Math.max(j,M),F=(0,n.useMemo)(()=>A.map(e=>{if(b!==void 0&&x!==void 0){let t=Math.min(b,x),n=Math.max(b,x),r=e.points.filter(e=>e.timestamp==null?!0:e.timestamp>=t&&e.timestamp<=n);return{...e,points:r}}if(N===0&&P===100)return e;let t=e.points.filter(e=>e.percentile>=N&&e.percentile<=P);return{...e,points:t}}),[A,b,x,N,P]),I=F.some(e=>e.points&&e.points.length>0);return A.length===0||!I?(0,s.jsx)(`svg`,{width:i,height:c,children:(0,s.jsx)(`text`,{x:i/2,y:c/2,textAnchor:`middle`,fill:`#999`,fontSize:`12`,children:`No data`})}):(0,s.jsx)(`div`,{children:(0,s.jsxs)(`svg`,{width:i,height:c,style:{overflow:`visible`},children:[F.map(e=>{let t=o(e.points,!1,k),n=o(e.points,!0,k),r=e.showArea&&e.points.length>0?[(0,s.jsx)(`path`,{d:n,fill:e.fillColor,stroke:`none`,opacity:_?.6:1},`area-${e.id}`)]:[],i=e.points.length>0?[(0,s.jsx)(`path`,{d:t,fill:`none`,stroke:e.color,strokeWidth:e.strokeWidth,strokeLinecap:`round`,strokeLinejoin:`round`},`line-${e.id}`)]:[],a=d===`none`?[]:e.points.flatMap(t=>{let n=t.isExtremum!==`none`;if(d===`extrema`&&!n)return[];let r=e.color??l,i=T??r,a=E??r,o=S??r,c=C??r,u=w??r,p;p=t.isExtremum===`peak`?i:t.isExtremum===`valley`?a:f===`none`||f===`segments`?r:t.trend===`up`?o:t.trend===`down`?c:u;let m=t.isExtremum===`none`?h:h+1;return[(0,s.jsx)(`circle`,{cx:t.x,cy:t.y,r:m,fill:p,stroke:`white`,strokeWidth:1.25},`dot-${e.id}-${t.index}`)]});return(0,s.jsxs)(`g`,{children:[r,i,f===`segments`||f===`both`?e.points.flatMap((t,n)=>{if(n===0)return[];let r=e.points[n-1],i=e.color??l,a=S??i,o=C??i,c=w??i,u=t.trend===`up`?a:t.trend===`down`?o:c;return[(0,s.jsx)(`line`,{x1:r.x,y1:r.y,x2:t.x,y2:t.y,stroke:u,strokeWidth:Math.max(1,e.strokeWidth+1),opacity:.6,strokeLinecap:`round`},`trend-${e.id}-${n}`)]}):[],a,e.points.flatMap(t=>{if(!t.label||D===`none`||D===`extrema`&&t.isExtremum===`none`)return[];let n=t.isExtremum!==`none`||t.trend===`up`||t.trend===`flat`?-(h+10):h+14,r=t.y+n;return[(0,s.jsx)(`text`,{x:t.x,y:r,fontSize:10,textAnchor:`middle`,style:{paintOrder:`stroke`},stroke:`#fff`,strokeWidth:3,fill:e.color??l,dominantBaseline:`central`,children:t.label},`label-${e.id}-${t.index}`)]})]},e.id)}),g&&(0,s.jsx)(`g`,{transform:`translate(0, ${k+10})`,children:A.flatMap((e,t)=>{if(!e?.label)return[];let n=t*100+10;return[(0,s.jsxs)(`g`,{children:[(0,s.jsx)(`line`,{x1:n,y1:10,x2:n+20,y2:10,stroke:e.color,strokeWidth:2}),(0,s.jsx)(`text`,{x:n+25,y:14,fontSize:`10`,fill:`#666`,children:e?.label??`-`})]},`legend-${e.id}`)]})})]})})}c.__docgenInfo={description:``,methods:[],displayName:`Trend`,props:{data:{required:!1,tsType:{name:`Array`,elements:[{name:`union`,raw:`| number
...
filtered/sliced data corresponding to the visible window. Otherwise it's
the original series (shallow-copied).`}]}},name:`ctx`}],return:{name:`ReactReactNode`,raw:`React.ReactNode`}}},description:``}}};var h={title:`Dumb/Trend`,component:c,parameters:{layout:`centered`},argTypes:{color:{control:`color`},fillColor:{control:`color`},width:{control:{type:`range`,min:100,max:800,step:10}},height:{control:{type:`range`,min:30,max:200,step:10}},strokeWidth:{control:{type:`range`,min:1,max:5,step:.5}},dotRadius:{control:{type:`range`,min:2,max:8,step:1}},pointMode:{control:{type:`radio`},options:[`none`,`all`,`extrema`]},trendMode:{control:{type:`radio`},options:[`none`,`segments`,`dots`,`both`]},upColor:{control:`color`},downColor:{control:`color`},flatColor:{control:`color`},peakColor:{control:`color`},valleyColor:{control:`color`}}};const g={name:`Empty State`,args:{data:[],width:300,height:60,pointMode:`none`,trendMode:`none`},render:e=>(0,s.jsxs)(`div`,{style:{padding:`20px`},children:[(0,s.jsx)(`h3`,{style:{marginBottom:`10px`,fontSize:`14px`,color:`#666`},children:`No Data Available`}),(0,s.jsx)(c,{...e})]})},_={name:`Trend`,args:{data:[50,50,50,52,54,54,54,53,53,55,55,55,53,50,48],width:300,height:60,pointMode:`extrema`,trendMode:`none`},render:e=>(0,s.jsx)(`div`,{style:{padding:`20px`},children:(0,s.jsx)(c,{...e})})},v={name:`Trends`,args:{series:[{id:`aapl`,label:`AAPL`,data:Array.from({length:30},(e,t)=>{let n=150+Math.sin(t/5)*15+Math.random()*8;return{value:Number(n.toFixed(2)),label:n.toFixed(2)}}),color:`#a855f7`,showArea:!1,strokeWidth:2},{id:`googl`,label:`GOOGL`,data:Array.from({length:30},(e,t)=>{let n=140+Math.cos(t/6)*12+Math.random()*6;return{value:Number(n.toFixed(2)),label:n.toFixed(2)}}),color:`#3b82f6`,showArea:!1,strokeWidth:2}],width:300,height:60,pointMode:`all`,trendMode:`none`,showPointLabels:`extrema`},render:e=>(0,s.jsx)(`div`,{style:{padding:`20px`},children:(0,s.jsx)(c,{...e})})},y={name:`Trend Indicators`,args:{data:[50,50,50,52,54,54,54,53,53,55,55,55,53,50,48],pointMode:`extrema`,trendMode:`both`,width:480,height:100,showArea:!1,strokeWidth:2,dotRadius:5,upColor:`var(--positive)`,downColor:`var(--negative)`,flatColor:`var(--neutral)`,peakColor:`yellow`,valleyColor:`black`,showLegend:!0},render:e=>(0,s.jsxs)(`div`,{style:{padding:`20px`},children:[(0,s.jsx)(`h3`,{style:{marginBottom:`10px`,fontSize:`14px`,color:`#666`},children:`Trend Direction Highlighting`}),(0,s.jsx)(c,{...e}),(0,s.jsxs)(`div`,{style:{marginTop:12,display:`flex`,gap:16,alignItems:`center`,fontSize:13},children:[(0,s.jsxs)(`span`,{style:{display:`inline-flex`,alignItems:`center`,gap:8},children:[(0,s.jsx)(`svg`,{width:`12`,height:`12`,children:(0,s.jsx)(`circle`,{cx:`6`,cy:`6`,r:`6`,fill:e.upColor})}),` `,`Up`]}),(0,s.jsxs)(`span`,{style:{display:`inline-flex`,alignItems:`center`,gap:8},children:[(0,s.jsx)(`svg`,{width:`12`,height:`12`,children:(0,s.jsx)(`circle`,{cx:`6`,cy:`6`,r:`6`,fill:e.downColor})}),` `,`Down`]}),(0,s.jsxs)(`span`,{style:{display:`inline-flex`,alignItems:`center`,gap:8},children:[(0,s.jsx)(`svg`,{width:`12`,height:`12`,children:(0,s.jsx)(`circle`,{cx:`6`,cy:`6`,r:`6`,fill:e.flatColor})}),` `,`Flat`]}),(0,s.jsxs)(`span`,{style:{display:`inline-flex`,alignItems:`center`,gap:8},children:[(0,s.jsx)(`svg`,{width:`12`,height:`12`,children:(0,s.jsx)(`circle`,{cx:`6`,cy:`6`,r:`6`,fill:e.peakColor})}),` `,`Peak`]}),(0,s.jsxs)(`span`,{style:{display:`inline-flex`,alignItems:`center`,gap:8},children:[(0,s.jsx)(`svg`,{width:`12`,height:`12`,children:(0,s.jsx)(`circle`,{cx:`6`,cy:`6`,r:`6`,fill:e.valleyColor})}),` `,`Valley`]})]})]})},b={name:`Compact Inline`,args:{data:[3,7,4,9,6,11,8,13],width:120,height:30,color:`#06b6d4`,fillColor:`rgba(6, 182, 212, 0.15)`,strokeWidth:2,pointMode:`none`,trendMode:`none`},render:e=>(0,s.jsxs)(`div`,{style:{padding:`20px`,display:`flex`,alignItems:`center`,gap:`15px`},children:[(0,s.jsx)(`span`,{style:{fontSize:`14px`,color:`#666`},children:`Revenue:`}),(0,s.jsx)(c,{...e}),(0,s.jsx)(`span`,{style:{fontSize:`16px`,fontWeight:`bold`},children:`$1.2M`})]})},x={name:`Stock Portfolio (5 Assets)`,args:{series:[{id:`aapl`,label:`AAPL`,data:Array.from({length:30},(e,t)=>150+Math.sin(t/5)*15+Math.random()*8),color:`#a855f7`,showArea:!1,strokeWidth:2},{id:`googl`,label:`GOOGL`,data:Array.from({length:30},(e,t)=>140+Math.cos(t/6)*12+Math.random()*6),color:`#3b82f6`,showArea:!1,strokeWidth:2},{id:`msft`,label:`MSFT`,data:Array.from({length:30},(e,t)=>145+Math.sin(t/4)*10+Math.random()*5),color:`#10b981`,showArea:!1,strokeWidth:2},{id:`amzn`,label:`AMZN`,data:Array.from({length:30},(e,t)=>135+Math.sin(t/7)*18+Math.random()*7),color:`#f59e0b`,showArea:!1,strokeWidth:2},{id:`tsla`,label:`TSLA`,data:Array.from({length:30},(e,t)=>130+Math.sin(t/3)*25+Math.random()*10),color:`#ef4444`,showArea:!1,strokeWidth:2}],width:700,height:160,showLegend:!0,pointMode:`all`,trendMode:`none`},render:e=>(0,s.jsxs)(`div`,{style:{padding:`25px`,background:`#0f172a`,borderRadius:`12px`},children:[(0,s.jsxs)(`div`,{style:{marginBottom:`20px`,display:`flex`,justifyContent:`space-between`,alignItems:`baseline`},children:[(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`h3`,{style:{fontSize:`20px`,color:`#fff`,marginBottom:`5px`},children:`Portfolio Performance`}),(0,s.jsx)(`p`,{style:{fontSize:`13px`,color:`#64748b`},children:`Last 30 trading days`})]}),(0,s.jsxs)(`div`,{style:{textAlign:`right`},children:[(0,s.jsx)(`div`,{style:{fontSize:`28px`,color:`#10b981`,fontWeight:`bold`},children:`+12.4%`}),(0,s.jsx)(`div`,{style:{fontSize:`12px`,color:`#64748b`},children:`Total return`})]})]}),(0,s.jsx)(c,{...e}),(0,s.jsx)(`div`,{style:{marginTop:`20px`,display:`grid`,gridTemplateColumns:`repeat(5, 1fr)`,gap:`10px`},children:[`AAPL`,`GOOGL`,`MSFT`,`AMZN`,`TSLA`].map((e,t)=>(0,s.jsxs)(`div`,{style:{padding:`10px`,background:`#1e293b`,borderRadius:`6px`,textAlign:`center`},children:[(0,s.jsx)(`div`,{style:{fontSize:`11px`,color:`#94a3b8`,marginBottom:`4px`},children:e}),(0,s.jsx)(`div`,{style:{fontSize:`14px`,fontWeight:`bold`,color:[`#a855f7`,`#3b82f6`,`#10b981`,`#f59e0b`,`#ef4444`][t]},children:[`+8.2%`,`+5.1%`,`+14.7%`,`+3.9%`,`+22.1%`][t]})]},e))})]})};var S=Date.now(),C=1440*60*1e3;const w={name:`Point Labels (extrema by default)`,args:{data:[{value:50},{value:50},{value:50,label:`flat`},{value:52,label:`small up`},{value:54,label:`rally`},{value:54},{value:54},{value:53},{value:53},{value:55,label:`higher`},{value:55},{value:55},{value:53,label:`dip`},{value:50,label:`fall`},{value:48,label:`valley`}],width:480,height:100,pointMode:`all`,trendMode:`both`,showArea:!1,strokeWidth:2,dotRadius:5,showPointLabels:`all`,upColor:`var(--positive)`,downColor:`var(--negative)`,flatColor:`var(--neutral)`,peakColor:`yellow`,valleyColor:`black`},render:e=>(0,s.jsxs)(`div`,{style:{padding:`20px`},children:[(0,s.jsx)(`h3`,{style:{marginBottom:`10px`,fontSize:`14px`,color:`#666`},children:`Labels: extrema shown by default`}),(0,s.jsx)(c,{...e}),(0,s.jsxs)(`p`,{style:{marginTop:12,fontSize:13,color:`#666`},children:[`Toggle `,(0,s.jsx)(`code`,{children:`showPointLabels`}),` in controls to test`,` `,(0,s.jsx)(`code`,{children:`"all"`}),` or `,(0,s.jsx)(`code`,{children:`"none"`}),`.`]})]})},T={name:`Sliding`,render:function(){let[e,t]=(0,n.useState)(!0),r=(e,t,n)=>({id:n,label:n.toUpperCase(),color:t,data:Array.from({length:60},(t,n)=>{let r=e(n);return{value:Number(r.toFixed(2)),label:r.toFixed(2),timestamp:S-(59-n)*C}}),showArea:!1,strokeWidth:2}),i=r(e=>150+Math.sin(e/5)*15+Math.random()*8,`#a855f7`,`aapl`),a=r(e=>140+Math.cos(e/6)*12+Math.random()*6,`#3b82f6`,`googl`),o=S-59*C,l=S,[u,d]=(0,n.useState)({min:o+1*C,max:l-1*C});return(0,s.jsx)(`div`,{style:{padding:20},children:(0,s.jsx)(m,{id:`trend-range-multi`,min:o,max:l,valueMin:u.min,valueMax:u.max,onChange:(e,t)=>d({min:e,max:t}),showRuler:!1,series:[i,a],minPoints:6,stretchToFit:e,children:({stretchedSeries:e})=>(0,s.jsx)(`div`,{style:{background:`#fff`,padding:12,borderRadius:8},children:(0,s.jsx)(c,{series:e??[],width:700,height:160,pointMode:`all`,trendMode:`none`,showArea:!1,strokeWidth:2,dotRadius:4,visibleStartPercent:0,visibleEndPercent:100,showPointLabels:`all`})})})})}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  name: "Empty State",
  args: {
    data: [],
    width: 300,
