import{N as e,a as t,c as n,d as r,et as i,f as a,i as o,l as s,m as c,n as l,o as u,r as d,s as f,t as p,u as m}from"./iframe-BwNSIbbV.js";import{t as h}from"./react-dom-LrvKekQb.js";import{n as g,t as _}from"./utils-BaIUY_Nw.js";import"./index.module-C_UjfPyb.js";import{n as v}from"./Flex-DtvvyBfY.js";import{l as y}from"./go-Di605n81.js";import"./Ring-Dw4RMm5y.js";import{n as b}from"./FocusScope-Z_uPQx9n.js";import{t as x}from"./useKeyboard-DD5t-pFf.js";import{t as S}from"./Button-Dwpu8NIj.js";import{t as C}from"./Shape-BY5_l8UX.js";var w=i(h(),1),T=e(),E={dialog:`_dialog_16rcq_1`,overlay:`_overlay_16rcq_15`,content:`_content_16rcq_31`,tray:`_tray_16rcq_35`,isOpen:`_isOpen_16rcq_54`,sheet:`_sheet_16rcq_58`,sentinel:`_sentinel_16rcq_92`},D=c();function O({onClose:e,children:t,isOpen:n,...r}){let i=(0,T.useRef)(null),{keyboardProps:a}=x({onKeyDown:t=>{t.key===`Escape`&&n&&(t.preventDefault(),e())}});return n?w.createPortal((0,D.jsx)(`div`,{...r,ref:i,className:_(r.className,E.dialog),tabIndex:-1,role:`dialog`,"aria-modal":`true`,...a,children:(0,D.jsx)(b,{contain:!0,restoreFocus:!0,autoFocus:!0,children:t})}),document.body):null}var k=Object.assign(O,{Actions:({children:e,className:t,dangerous:n})=>(0,D.jsx)(`footer`,{...t!==void 0&&{className:t},...g(n)&&{style:n},children:e}),Title:({children:e,className:t,dangerous:n})=>(0,D.jsx)(`header`,{...t!==void 0&&{className:t},...g(n)&&{style:n},children:e}),Content:({children:e,className:t,dangerous:n})=>(0,D.jsx)(`div`,{className:_(E.content,t),...g(n)&&{style:n},children:e})});function A({isOpen:e,onClose:t,trigger:n,unTrigger:r,children:i,className:a}){let o=(0,T.useRef)(null),s=(0,T.useRef)(null),c=(0,T.useRef)(null),l=(0,T.useCallback)(()=>{t()},[t]);(0,T.useEffect)(()=>{e?c.current?.scrollIntoView({behavior:`smooth`}):s.current?.scrollIntoView({behavior:`smooth`})},[e]);let{keyboardProps:u}=x({onKeyDown:n=>{(n.key===`Escape`||n.key===`C`)&&e&&(n.preventDefault(),t())}});return(0,D.jsxs)(D.Fragment,{children:[n?.({isOpen:e}),(0,D.jsxs)(`div`,{ref:o,className:_(E.sheet,a),"data-open":e?`true`:`false`,"aria-hidden":!e,...u,children:[(0,D.jsx)(`div`,{ref:s,className:E.sentinel}),(0,D.jsx)(`menu`,{ref:c,className:E.menu,"aria-label":`Actions`,children:i}),(0,D.jsx)(`menu`,{className:E.menu,children:r({isOpen:e,onClose:l})})]})]})}A.__docgenInfo={description:``,methods:[],displayName:`ActionSheet`,props:{isOpen:{required:!0,tsType:{name:`boolean`},description:``},onClose:{required:!0,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``},trigger:{required:!1,tsType:{name:`RenderProp`,elements:[{name:`signature`,type:`object`,raw:`{
    isOpen: boolean;
