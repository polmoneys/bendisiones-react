import{R as e,_ as t,a as n,c as r,d as i,f as a,i as o,l as s,n as c,o as l,p as u,r as d,s as f,t as p,u as m}from"./iframe-CdwTt1uH.js";import{t as h}from"./react-dom-BEPidDKC.js";import{l as g,t as _}from"./Button-CgkXy0EA.js";import{n as v,t as y}from"./utils-BaIUY_Nw.js";import"./Ring-D22CVcNJ.js";import{a as b,n as x}from"./FocusScope-DmycqiK9.js";import{t as S}from"./Shape-BhCTcShP.js";var C=e(h(),1),w=t(),T={dialog:`_dialog_16rcq_1`,overlay:`_overlay_16rcq_15`,content:`_content_16rcq_31`,tray:`_tray_16rcq_35`,isOpen:`_isOpen_16rcq_54`,sheet:`_sheet_16rcq_58`,sentinel:`_sentinel_16rcq_92`},E=u();function D({onClose:e,children:t,isOpen:n,...r}){let i=(0,w.useRef)(null),{keyboardProps:a}=b({onKeyDown:t=>{t.key===`Escape`&&n&&(t.preventDefault(),e())}});return n?C.createPortal((0,E.jsx)(`div`,{...r,ref:i,className:y(r.className,T.dialog),tabIndex:-1,role:`dialog`,"aria-modal":`true`,...a,children:(0,E.jsx)(x,{contain:!0,restoreFocus:!0,autoFocus:!0,children:t})}),document.body):null}var O=Object.assign(D,{Actions:({children:e,className:t,dangerous:n})=>(0,E.jsx)(`footer`,{...t!==void 0&&{className:t},...v(n)&&{style:n},children:e}),Title:({children:e,className:t,dangerous:n})=>(0,E.jsx)(`header`,{...t!==void 0&&{className:t},...v(n)&&{style:n},children:e}),Content:({children:e,className:t,dangerous:n})=>(0,E.jsx)(`div`,{className:y(T.content,t),...v(n)&&{style:n},children:e})});function k({isOpen:e,onClose:t,trigger:n,unTrigger:r,children:i,className:a}){let o=(0,w.useRef)(null),s=(0,w.useRef)(null),c=(0,w.useRef)(null),l=(0,w.useCallback)(()=>{t()},[t]);(0,w.useEffect)(()=>{e?c.current?.scrollIntoView({behavior:`smooth`}):s.current?.scrollIntoView({behavior:`smooth`})},[e]);let{keyboardProps:u}=b({onKeyDown:n=>{(n.key===`Escape`||n.key===`C`)&&e&&(n.preventDefault(),t())}});return(0,E.jsxs)(E.Fragment,{children:[n?.({isOpen:e}),(0,E.jsxs)(`div`,{ref:o,className:y(T.sheet,a),"data-open":e?`true`:`false`,"aria-hidden":!e,...u,children:[(0,E.jsx)(`div`,{ref:s,className:T.sentinel}),(0,E.jsx)(`menu`,{ref:c,className:T.menu,"aria-label":`Actions`,children:i}),(0,E.jsx)(`menu`,{className:T.menu,children:r({isOpen:e,onClose:l})})]})]})}k.__docgenInfo={description:``,methods:[],displayName:`ActionSheet`,props:{isOpen:{required:!0,tsType:{name:`boolean`},description:``},onClose:{required:!0,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``},trigger:{required:!1,tsType:{name:`RenderProp`,elements:[{name:`signature`,type:`object`,raw:`{
    isOpen: boolean;
...
}`,...Z.parameters?.docs?.source}}};const Q=[`StoryA`];export{Z as StoryA,Q as __namedExportsOrder,X as default};